  ...
  render: (args) => ({
    ...
    template: `
      ...
      <section :data-theme="theme">
        ...
        <fitx-switch :theme="theme" label="Disabled Unselected" v-model="falseValue" disabled="disabled" />
        <fitx-switch :theme="theme" label="Disabled Unselected Hover" fake-modifier="hover" v-model="falseValue" disabled="disabled" />
        <fitx-switch :theme="theme" label="Disabled Unselected Focus" fake-modifier="focus" v-model="falseValue" disabled="disabled" />
      </section>

      <section :data-theme="theme">
        <h1>Switch Disabled Selected</h1>
        <fitx-switch :theme="theme" label="Disabled Selected" v-model="trueValue" disabled="disabled" />
        <fitx-switch :theme="theme" label="Disabled Selected Hover" fake-modifier="hover" v-model="trueValue" disabled="disabled" />
        <fitx-switch :theme="theme" label="Disabled Selected Focus" fake-modifier="focus" v-model="trueValue" disabled="disabled" />
      </section>
    `,
  }),
};
